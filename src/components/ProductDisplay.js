...
const ProductDisplay = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex">
      <img alt="ecommerce" className="  h-64 object-cover object-center rounded" src="https://dummyimage.com/400x400"></img>
      <div className=" w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Shirt</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Lake Wickaboag Boat Club</h1>
